...
Deploy deploy deploy 🚀! While having our _Airbrb_ working locally is fun and all, there's no point if you can't show it off to everyone else 😎!
...
- Make sure you are in Airbrb repository.
...
2. Name your repository, e.g. "`airbrb-deploy`", and make sure to select **Private**. Then hit **Create Repository**.
   <details close>
...
# E.g. git@github.com:USERNAME/airbrb-deploy.git
